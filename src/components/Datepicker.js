...
import { weeks, months, endofmonths, leapyearsindex, allyears } from './datepicker/data';
...
export function Datepicker() {
  ...
  ConvertToAd(yearindex, monthindex, day);
  ...
  useEffect(() => {
    ...
    setTimeout(() => setNepaliDate(`${currentyear}-${monthindex + 1}-${day}`), 0);
